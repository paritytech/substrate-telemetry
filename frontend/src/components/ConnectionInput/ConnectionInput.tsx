...
function ConnectionInput() {
  ...
  return (
    <div className="ConnectionInput-connection">
      <div >
        <input name="connectionURL" placeholder="ws://YOUR_IP:YOUR_PORT/feed" type="text"
          onChange={handleChange} defaultValue={connectionURI} />
        <button onClick={handleSubmit}>save</button>
      </div>
      <div>
        <span className="ConnectionInput-error">
          {error}
        </span>
      </div>
    </div>

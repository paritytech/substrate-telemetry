...
import { formatNumber, secondsWithPrecision, MultiCounter } from '../../utils';
import { Tab, Chain } from './';
import { Tile, VersionsTile, Ago } from '../';
  ...
  public render() {
    ...
    return (
      <div className="Header">
        ...
        <VersionsTile nodeVersions={nodeVersions} stateRef={nodeVersionsRef} />
